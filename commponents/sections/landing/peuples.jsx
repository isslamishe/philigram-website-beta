    ...
    <div className="flex flex-col  bg-white gap-0 bg-no-repeat bg-cover bg-center relative w-screen min-h-screen">
      ...
      <div className="relative z-30 w-screen h-screen">
        ...
        <button
          ...
          className="absolute cursor-pointer left-[3%] top-1/2 -translate-y-1/2 z-40 w-[8vh] md:w-[10vh] aspect-square bg-white/30 flex items-center justify-center"
        >
        ...
        <button
          ...
          className="absolute right-[3%] cursor-pointer top-1/2 -translate-y-1/2 z-40 w-[8vh] md:w-[10vh] aspect-square bg-white/30 flex items-center justify-center"
        >
          <div className="relative w-1/3 h-1/3 rotate-180">
        ...
        >
          {Peuples.map((peuple, index) => (
            <div
              key={index}
              className="relative flex overflow-visible h-screen w-screen shrink-0 snap-center flex-col items-center justify-end pb-[10%]"
            >
              ...
              <div className="absolute inset-x-0 z-5 h-full w-full -bottom-[15%]">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#19275E]/50 z-10" />
                <Image
                  fill
                  src={peuple.image}
                  alt={peuple.name}
                  className="object-cover inset-0 absolute scale-100 lg:scale-115 lg:object-contain"
                />
              </div>
            </div>
          ))}
