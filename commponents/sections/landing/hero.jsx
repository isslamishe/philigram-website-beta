...
export default function hero() {
  return (
    ...
    bg-clip-text
    text-transparent  text-[clamp(0.8rem,10vw,5rem)] md:text-[clamp(1rem,10vw,5rem)] lg:text-[clamp(1rem,15vw,7rem)]"
      >
        Ascendia Rise
      </span>
      <div className=" flex flex-col gap-2 justify-center items-center grow-0">
        {" "}
        <span className=" font-serif72 z-30 font-light text-center  text-white/90 md:text-[clamp(0.8rem,1vw,1rem)] text-[clamp(0.8rem,3vw,1.3rem)]">
          QUAND DEUX MONDES NE FONT QU'UN
        </span>
        <span className=" font-sans z-30 max-w-[75%] text-center font-light text-white text-[clamp(0.7rem,5vw,0.9rem)]">
      ...
      <button className="z-30 cursor-pointer text-[#403E37]  font-bold mt-10  p-5  bg-primary ">
        PRÉ-INSCRIPTION
      </button>

      <Link className="z-30 text-sm border-b" href="/">
        {" "}
        DÉCOUVRIR L'HISTOIRE
      </Link>

      <span className="z-30 absolute bottom-[5%] text-[0.6rem]">
